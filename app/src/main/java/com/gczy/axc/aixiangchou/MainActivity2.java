...
//            return true;//返回true表明点击网页里面的连接还是在当前的webview里跳转,不跳到浏览器
            ...
            if (url.startsWith("weixin://wap/pay?")) {
                if (!uninstallSoftware(MainActivity2.this, "com.tencent.mm")) {
//没有安装
                    Toast.makeText(MainActivity2.this, "请先安装微信!", Toast.LENGTH_LONG).show();
                    return true;
                } else {
                    //已经安装，可以操作接下来的操作
    ...
    private void permission() {
        ActivityCompat.requestPermissions(MainActivity2.this, new String[]{android
